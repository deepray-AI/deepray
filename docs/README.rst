...
Documentation for DeePray is generated using `Sphinx <https://www.sphinx-doc.org/>`__
...
is generated automatically from comments in `config file <https://github.com/microsoft/DeePray/blob/master/include/DeePray/config.h>`__
by `this script <https://github.com/microsoft/DeePray/blob/master/helpers/parameter_generator.py>`__.

After each commit on ``master``, documentation is updated and published to `Read the Docs <https://deepray.readthedocs.io/>`__.

Build
-----

It is not necessary to re-build this documentation while modifying DeePray's source code.
