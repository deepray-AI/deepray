...
from .. import sparse_image_warp
from ..sparse_image_warp import _get_boundary_locations
from ..sparse_image_warp import _get_grid_locations
...
def test_smiley_face():
    ...
    input_file = get_path_to_datafile("custom_ops/image/python/tests/test_data/Yellow_Smiley_Face.png")
    ...
    for interpolation_order in (1, 2, 3):
        for num_boundary_points in (0, 1, 4):
            ...
            target_file = get_path_to_datafile(
                "custom_ops/image/python/tests/test_data/Yellow_Smiley_Face_Warp-interp"
