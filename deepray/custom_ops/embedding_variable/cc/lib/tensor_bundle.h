...
#ifndef TENSORFLOW_CORE_UTIL_TENSOR_BUNDLE_TENSOR_BUNDLE_EV_H_
#define TENSORFLOW_CORE_UTIL_TENSOR_BUNDLE_TENSOR_BUNDLE_EV_H_
...
class BundleWriter {
 ...
 private:
  ...
  bool use_temp_file_;
  std::unique_ptr<tsl::BufferedWritableFileEV> out_;
...
#endif  // TENSORFLOW_CORE_UTIL_TENSOR_BUNDLE_TENSOR_BUNDLE_EV_H_
