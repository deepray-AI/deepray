...
#ifndef DEEPRAY_CUSTOM_OPS_KERNELS_CORRELATION_COST_OP_H_
#define DEEPRAY_CUSTOM_OPS_KERNELS_CORRELATION_COST_OP_H_
...
#endif  // DEEPRAY_CUSTOM_OPS_KERNELS_CORRELATION_COST_OP_H_
