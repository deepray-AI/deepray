...
REGISTER_OP("KvVariableGroupSparseApplyAdamV2")
    ...
    .Attr("Tindices: {int32, int64, uint64, string}")
    .Attr("use_locking: bool = false")
    .SetShapeFn([](InferenceContext* c) { return GroupApplyAdamShapeFn(c); });
...
REGISTER_OP("KvVariableSparseApplyAdagrad")
    ...
    .SetShapeFn([](InferenceContext* c) { return ApplyAdagradShapeFn(c); });
...
static Status ApplyAdadeltaShapeFn(InferenceContext* c) {
  ...
  TF_RETURN_IF_ERROR(HandleGradAndIndicesInputs(c, true, 6 /* grad_idx */, &s));
  if (c->num_outputs() > 0) {
    c->set_output(0, s);
  }
  return ::tensorflow::OkStatus();
...
REGISTER_OP("KvVariableSparseApplyAdadelta")
    ...
    .Attr("Tindices: {int32, int64, uint64, string}")
    .Attr("use_locking: bool = false")
    .SetShapeFn([](InferenceContext* c) { return ApplyAdadeltaShapeFn(c); });
...
REGISTER_OP("KvVariableGroupSparseApplyLamb")
    ...
    .Attr("Tindices: {int32, int64, uint64, string}")
    .Attr("use_locking: bool = false")
    .SetShapeFn([](InferenceContext* c) { return GroupApplyLambShapeFn(c); });
...
REGISTER_OP("KvVariableGroupSparseApplyAdaDQH")
    ...
    .Attr("Tindices: {int32, int64, uint64, string}")
    .Attr("use_locking: bool = false")
    .SetShapeFn([](InferenceContext* c) { return GroupApplyAdaDQHShapeFn(c); });
...
REGISTER_OP("KvVariableGroupSparseApplyAdamNewV2")
    ...
    .Attr("Tindices: {int32, int64, uint64, string}")
    .Attr("use_locking: bool = false")
    .SetShapeFn([](InferenceContext* c) { return GroupApplyAdamV2ShapeFn(c); });
...
REGISTER_OP("KvVariableGroupSparseApplyAdamV3")
    ...
    .Attr("Tindices: {int32, int64, uint64, string}")
    .Attr("use_locking: bool = false")
    .SetShapeFn([](InferenceContext* c) { return GroupApplyAdamV3ShapeFn(c); });
