...
class SparseGroupFtrlOptimizer(TFFtrlOptimizer):
  ...
  def _resource_apply_sparse(self, grad, var, indices):
    if not isinstance(var, KvVariable):
      return super(SparseGroupFtrlOptimizer, self)._resource_apply_sparse(grad, var, indices)
    ...
    return gen_kv_variable_ops.kv_variable_sparse_group_sparse_apply_ftrl_v2(
        ...
        math_ops.cast(self._adjusted_l2_regularization_strength_tensor, grad.dtype),
