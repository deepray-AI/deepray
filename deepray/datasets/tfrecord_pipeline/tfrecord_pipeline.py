...
class TFRecordDataset(DataPipeLine):
  ...
  def parser(self, record):
    tensor, sparse_tensor, ragged_tensor = tf.io.parse_sequence_example(serialized=record, context_features=self.context_features, sequence_features=self.sequence_features)
