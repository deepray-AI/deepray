...
from deepray.datasets.movielens import constants as rconst, stat_utils
from deepray.datasets.movielens import popen_helper
...
class DatasetManager(object):
  ...
  def put(self, index, data):
    ...
    if self._is_training:
      ...
      batch_size = data[rconst.ITEM_COLUMN].shape[0]
  ...
  def get_dataset(self, batch_size, epochs_between_evals):
    ...
    if self._stream_files:
      ...
      types = {
        rconst.USER_COLUMN: rconst.USER_DTYPE,
        rconst.ITEM_COLUMN: rconst.ITEM_DTYPE
      }
      shapes = {
