...
class GooglePretrainedWeightDownloader:
    def __init__(self, save_path):
        ...
        # Download urls
        self.model_urls = {
            'bert_base_uncased': ('http://minio1.arsenal.kanzhun-inc.com/datasets/bert_models/google_pretrained_weights/uncased_L-12_H-768_A-12.tar.gz', 'uncased_L-12_H-768_A-12.tar.gz'),
            'bert_large_uncased': ('http://minio1.arsenal.kanzhun-inc.com/datasets/bert_models/google_pretrained_weights/uncased_L-24_H-1024_A-16.tar.gz', 'uncased_L-24_H-1024_A-16.tar.gz'),
