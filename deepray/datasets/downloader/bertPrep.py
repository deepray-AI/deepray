  ...
  if args.action == 'download':
    ...
    if args.dataset == 'bookscorpus':
      ...
      if args.skip_wikiextractor == 0:
        ...
        wikiextractor_command = path_to_wikiextractor_in_container + ' ' + directory_structure['download'] + '/' + args.dataset + '/wikicorpus_en.xml ' + '-b 100M --processes ' + str(
      ...
      if args.skip_wikiextractor == 0:
        ...
        wikiextractor_command = path_to_wikiextractor_in_container + ' ' + directory_structure['download'] + '/' + args.dataset + '/wikicorpus_zh.xml ' + '-b 100M --processes ' + str(
          args.n_processes) + ' -o ' + directory_structure['extracted'] + '/' + args.dataset
        print('WikiExtractor Command:', wikiextractor_command)
        wikiextractor_process = subprocess.run(wikiextractor_command, shell=True, check=True)
