...
class KafkaDataset(DataPipeLine):
    def parse(self, raw_message, raw_key):
        ...
        tensor, sparse_tensor = tf.io.parse_single_sequence_example(serialized=raw_message, context_features=context_features, sequence_features=sequence_features)
        reshaped_tensor = {}
    ...
    def build_dataset(self):
        dataset = (
            ...
            .map(map_func=self.parse, num_parallel_calls=FLAGS.parallel_parse)
