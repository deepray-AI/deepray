...
class Squad(DataPipeLine):
  ...
  def build_dataset(self, input_file_pattern,
    ...
    if self.dataset_type == "squad":
      ...
      return self.create_classifier_dataset()
    else:
  ...
  def create_pretrain_dataset(self, input_patterns,
                              seq_length,
  ...
  def create_classifier_dataset(self, file_path,
                                seq_length,
                                batch_size,
                                is_training=True):
    ...
    if self.context and self.context.num_input_pipelines > 1:
      dataset = dataset.shard(self.context.num_input_pipelines,
                              self.context.input_pipeline_id)
  ...
  def create_squad_dataset(self, file_path,
                           seq_length,
                           batch_size,
                           is_training=True,
                           input_pipeline_context=None,
