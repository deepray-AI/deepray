...
from deepray.metrics import RSquare
from deepray.metrics.r_square import _VALID_MULTIOUTPUT
...
def test_keras_fit():
  ...
  data = tf.data.Dataset.from_tensor_slices((tf.random.normal(shape=(100, 1)), tf.random.normal(shape=(100, 1))))
  data = data.batch(10)
