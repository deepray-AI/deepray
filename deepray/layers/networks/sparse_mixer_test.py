...
class SparseMixerTest(parameterized.TestCase, tf.test.TestCase):
  ...
  def test_network(
    ...
    batch_size = 4
    word_ids = tf.keras.Input(shape=(sequence_length,), batch_size=batch_size, dtype=tf.int32)
    mask = tf.keras.Input(shape=(sequence_length,), batch_size=batch_size, dtype=tf.int32)
    type_ids = tf.keras.Input(shape=(sequence_length,), batch_size=batch_size, dtype=tf.int32)
