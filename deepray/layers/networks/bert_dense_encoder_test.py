...
class BertEncoderV2Test(tf.test.TestCase, parameterized.TestCase):
  ...
  def test_dict_outputs_network_creation(self):
    ...
    expected_data_shape = [None, sequence_length + dense_sequence_length, hidden_size]
  ...
  def test_dict_outputs_network_invocation(self, encoder_cls, output_range, out_seq_len):
    ...
    dense_input_data = np.random.rand(batch_size, dense_sequence_length, hidden_size)
