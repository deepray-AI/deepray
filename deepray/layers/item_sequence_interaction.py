...
from .item_item_interaction import DIENAttentionUnit
from .rnn import AUGRU
...
class DIENItemSequenceInteractionBlock(tf.keras.layers.Layer):
  def __init__(self, hidden_size: int):
    ...
    self.hist_gru = tf.keras.layers.GRU(self.hidden_size, return_sequences=True)
    self.hist_augru = AUGRU(self.hidden_size)
