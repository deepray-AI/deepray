...
from deepray.image import utils as img_utils
...
def sparse_image_warp(
    ...
    (`dp.image.interpolate_spline`) to interpolate the displacements
    between the corresponding control points to a dense flow field.
    Then, we warp the image using this dense flow field
    (`dp.image.dense_image_warp`).
    ...
    See `dp.image.interpolate_spline` for further documentation of the
