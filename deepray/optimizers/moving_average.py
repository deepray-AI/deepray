...
from deepray.optimizers import AveragedOptimizerWrapper
...
class MovingAverage(AveragedOptimizerWrapper):
    ...
    def _prepare_local(self, var_device, var_dtype, apply_state):
        ...
        apply_state[(var_device, var_dtype)]["dp_ma_decay"] = self._get_decay(
    ...
    def average_op(self, var, average_var, local_apply_state):
        return tf.keras.backend.moving_average_update(
            average_var, var, local_apply_state["dp_ma_decay"]
        )
