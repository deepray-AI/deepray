...
from deepray.text import crf_log_likelihood
...
class CRFModelWrapper(tf.keras.Model):
  ...
  def __init__(
    ...
    # dp.layers.CRF -> dp.text.__init__ -> dp.text.crf_wrapper -> dp.layers.CRF
  ...
  def train_step(self, data):
    ...
    with tf.GradientTape() as tape:
      (potentials, sequence_length, kernel), decoded_sequence, *_ = self(x, training=True, return_crf_internal=True)
