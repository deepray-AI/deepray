            ...
            if K.int_shape(symbolic_weight) != saved_weight_value.shape:
              ...
              try:
                ...
                if ignore_mismatched_sizes:
                  missmatched_keys.add((layer_name, saved_weight_value.shape, K.int_shape(symbolic_weight)))
                  continue
                else:
                  raise e
            else:
  ...
  def push_to_hub(
    ...
    **model_card_kwargs,
    ...
    with working_or_temp_dir(working_dir=working_dir, use_temp_dir=use_temp_dir) as work_dir:
      ...
      self._upload_modified_files(work_dir, repo_id, files_timestamps, commit_message=commit_message, token=token)
