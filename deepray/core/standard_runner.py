...
class StandardTrainer(runner.AbstractTrainer, metaclass=abc.ABCMeta):
  ...
  def __init__(self, train_dataset, options: Optional[StandardTrainerOptions] = None):
...
class StandardEvaluator(runner.AbstractEvaluator, metaclass=abc.ABCMeta):
  ...
  def __init__(self, eval_dataset, options: Optional[StandardEvaluatorOptions] = None):
  ...
  def eval_reduce(self, state: Optional[Any] = None, step_outputs: Optional[runner.Output] = None) -> Any:
