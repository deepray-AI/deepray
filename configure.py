...
def create_build_configuration():
  ...
  write("build -c opt")
  write("build --cxxopt=" + '"-D_GLIBCXX_USE_CXX11_ABI=' + str(tf.sysconfig.CXX11_ABI_FLAG) + '"')
...
def configure_cuda():
  ...
  write_action_env("CUDA_TOOLKIT_PATH", os.getenv("CUDA_TOOLKIT_PATH", "/usr/local/cuda"))
  write_action_env(
      "CUDNN_INSTALL_PATH",
      os.getenv("CUDNN_INSTALL_PATH", "/usr/lib/x86_64-linux-gnu"),
  )
  write_action_env("TF_CUDA_VERSION", os.getenv("TF_CUDA_VERSION", "11.6"))
