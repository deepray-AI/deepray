load("@//deepray/tsl:tsl.bzl", "tf_openmp_copts")
load("@//third_party/mkl:build_defs.bzl", "if_mkl")
load("@//third_party/mkl_dnn:build_defs.bzl", "if_mkldnn_openmp")
load("@//third_party/mkl:build_defs.bzl", "if_mkl_ml")
...
expand_template(
    ...
    substitutions = select({
        "@//third_party/mkl_dnn:build_with_mkldnn_openmp": _DNNL_RUNTIME_OMP,
...
cc_library(
    ...
    linkopts = select({
        "@//deepray/tsl:linux_aarch64": ["-lrt"],
        "@//deepray/tsl:linux_x86_64": ["-lrt"],
        "@//deepray/tsl:linux_ppc64le": ["-lrt"],
        "//conditions:default": [],
    }),
    textual_hdrs = _TEXTUAL_HDRS_LIST,
    visibility = ["//visibility:public"],
