...
expand_template(
    ...
    substitutions = select({
        "@//deepray/tsl:linux_x86_64": _INCLUDE_HWLOC_AUTOIGEN_CONFIG_H_LINUX_SUBS,
...
expand_template(
    ...
    template = "@//third_party/hwloc:static-components.h",
)
...
cc_library(
    ...
    srcs = [
        ...
        "@//deepray/tsl:linux_x86_64": [
            "hwloc/topology-linux.c",
            "hwloc/topology-x86.c",
            "include/hwloc/linux.h",
            "include/private/cpuid-x86.h",
        ],
        "@//deepray/tsl:linux_aarch64": [
            "hwloc/topology-linux.c",
            "include/hwloc/linux.h",
        ],
        "@//deepray/tsl:linux_ppc64le": [
            "hwloc/topology-linux.c",
            "include/hwloc/linux.h",
        ],
        "@//deepray/tsl:freebsd": [
